...
import op.mobile.app.dev.travelapp.databinding.ClusterMarkerBinding
import op.mobile.app.dev.travelapp.databinding.ClusterMarkerInfoWindowBinding
...
class CompanyMarkerCluster (
    ...
    ClusterManager.OnClusterClickListener<Company>,
